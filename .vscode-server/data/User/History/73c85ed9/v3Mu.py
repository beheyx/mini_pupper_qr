...
class MovementGroups:
    ...
    def __init__(self):
        ...
        self.current_legs = [[[0.06, -0.05, -0.07]], [[0.06, 0.05, -0.07]], [[-0.06, -0.05, -0.07]], [[-0.06, 0.05, -0.07]]]  # Start with default stance
        self.current_speed = [[0, 0, 0]]  # speed_x, speed_y, no_use
        self.current_attitude = [[0, 0, 0]]  # roll, pitch, yaw degree
    ...
    def compute_leg_positions(self, current_legs, attitude):
            """
            Compute updated leg positions based on the current attitude.
            This is a placeholder function; it needs to be implemented based on your robot's kinematics.
            """
            # Example: Adjust leg positions based on roll, pitch, and yaw
            updated_legs = current_legs  # Modify this logic based on actual kinematics
            return updated_legs
...
########## The level1 simple APIs without input parameters ###########
    ...
    def look_down(self):
        ...
        self.current_attitude = dance_attitude
        self.current_legs = self.compute_leg_positions(dance_all_legs, dance_attitude)  # Update legs
        return self.MovementLib
    ...
    def move_forward(self):
        ...
        dance_all_legs = self.
        dance_speed = [[0.20,0,0]]    # speed_x, speed_y, no_use
        dance_attitude = self.position   # roll, pitch, yaw degree
        dance_scheme.setAllSequence(dance_all_legs,dance_speed,dance_attitude)
        self.MovementLib.append(dance_scheme)      # append dance
        return self.MovementLib
...
##### The level3 samples to DIY complicated movement   #######
    ...
    def body_cycle(self):
        ...
        dance_scheme.setLegsSequence(dance_all_legs,"Multiple",2)
        dance_scheme.setAttitudeSequence(dance_attitude,"Multiple",2)
        dance_scheme.setSpeedSequence(dance_speed,"Multiple",2)
        self.MovementLib.append(dance_scheme)      # append dance
